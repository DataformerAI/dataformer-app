...
import warnings
try:
    from dfapp.load import upload_file
except ImportError:
    warnings.warn("DataformerApp provides a function to help you upload files to the flow. Please install dfapp to use it.")
    upload_file = None
...
def main():
    ...
    if args.upload_file:
        if not upload_file:
            raise ImportError("DataformerApp is not installed. Please install it to use the upload_file function.")

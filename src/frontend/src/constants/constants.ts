...
export const DESCRIPTIONS: string[] = [
  ...
  "DataformerApp: Create, Chain, Communicate.",
  ...
  "Design Dialogues with DataformerApp.",
...
export const DFAPP_CHAT_TITLE = "DataformerApp Chat";
...
export const STORE_TITLE = "DataformerApp Store";
export const NO_API_KEY = "You don't have an API key. ";
export const INSERT_API_KEY = "Insert your DataformerApp API key.";

  ...
  useEffect(() => {
    ...
    const isAuthorizedURL = (url) => {
      const authorizedDomains = [
        "https://raw.githubusercontent.com/dfapp-ai/dfapp_examples/main/examples",
        "https://api.github.com/repos/dfapp-ai/dfapp_examples/contents/examples",
        "https://api.github.com/repos/dfapp-ai/dfapp",
        "auto_login",
      ];

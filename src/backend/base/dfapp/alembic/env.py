...
from dfapp.services.database.models import *  # noqa
from dfapp.services.database.service import SQLModel
...
def run_migrations_offline() -> None:
    ...
    """
    url = os.getenv("DFAPP_DATABASE_URL")
...
def run_migrations_online() -> None:
    ...
    try:
        ...
        from dfapp.services.manager import initialize_settings_service, service_manager

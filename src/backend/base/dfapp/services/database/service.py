...
from dfapp.services.database import models  # noqa
from dfapp.services.database.models.user.crud import get_user_by_username
from dfapp.services.database.utils import Result, TableResults
from dfapp.services.deps import get_settings_service
from dfapp.services.utils import teardown_superuser
...
class DatabaseService(Service):
    ...
    def __init__(self, database_url: str):
        ...
        # This file is in dfapp.services.database.manager.py
        # the ini is in dfapp
        dfapp_dir = Path(__file__).parent.parent.parent
        self.script_location = dfapp_dir / "alembic"
        self.alembic_cfg_path = dfapp_dir / "alembic.ini"

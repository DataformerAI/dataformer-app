...
from dfapp.api.utils import check_dfapp_version
from dfapp.services.auth import utils as auth_utils
from dfapp.services.database.models.user.model import User
from dfapp.services.deps import get_settings_service, get_store_service
from dfapp.services.store.exceptions import CustomException
...
async def share_component(
    ...
    try:
        await check_dfapp_version(component)

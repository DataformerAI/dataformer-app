...
from dfapp.api.v1.schemas import Token
from dfapp.services.auth.utils import (
    authenticate_user,
...
from dfapp.services.deps import get_session, get_settings_service, get_variable_service
